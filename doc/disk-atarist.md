...
To read:
  ...
  - `fluxengine read -c atarist --360 -s drive:0 -o atarist.st`
  - `fluxengine read -c atarist --370 -s drive:0 -o atarist.st`
  - `fluxengine read -c atarist --400 -s drive:0 -o atarist.st`
  - `fluxengine read -c atarist --410 -s drive:0 -o atarist.st`
  - `fluxengine read -c atarist --720 -s drive:0 -o atarist.st`
  - `fluxengine read -c atarist --740 -s drive:0 -o atarist.st`
  - `fluxengine read -c atarist --800 -s drive:0 -o atarist.st`
  - `fluxengine read -c atarist --820 -s drive:0 -o atarist.st`
