...
To read:
  ...
  - `fluxengine read -c micropolis --143 -s drive:0 -o micropolis.img`
  - `fluxengine read -c micropolis --287 -s drive:0 -o micropolis.img`
  - `fluxengine read -c micropolis --315 -s drive:0 -o micropolis.img`
  - `fluxengine read -c micropolis --630 -s drive:0 -o micropolis.img`

To write:

  - `fluxengine write -c micropolis --143 -d drive:0 -i micropolis.img`
  - `fluxengine write -c micropolis --287 -d drive:0 -i micropolis.img`
  - `fluxengine write -c micropolis --315 -d drive:0 -i micropolis.img`
  - `fluxengine write -c micropolis --630 -d drive:0 -i micropolis.img`
