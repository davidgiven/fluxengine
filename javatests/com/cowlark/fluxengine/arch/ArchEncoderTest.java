...
public class ArchEncoderTest
{
    ...
    public void createAmigaEncoder()
    {
        ...
        assertThat(encoder).isInstanceOf(
                com.cowlark.fluxengine.arch.amiga.AmigaEncoder.class);
    }
    ...
    public void createIbmEncoder()
    {
        ...
        assertThat(encoder).isInstanceOf(
                com.cowlark.fluxengine.arch.ibm.IbmEncoder.class);
    }
    ...
    public void createTartuEncoder()
    {
        ...
        assertThat(encoder).isInstanceOf(
                com.cowlark.fluxengine.arch.tartu.TartuEncoder.class);
    }
}
