...
public class MicrodosFilesystemTest extends GenericFilesystemTest
{
    ...
    public void setup()
    {
        configProto = new ConfigBuilder().loadConfigFile("ms2000").withImageWriter("/tmp/out.img").build();
    ...
    public void createTestFilesystem()
    {
        ...
        impl = new MicrodosFilesystem(configProto.getFilesystem().getMicrodos(), blockDevice);
    }
}
