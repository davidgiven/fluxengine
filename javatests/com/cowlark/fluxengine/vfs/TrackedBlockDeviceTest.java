...
public class TrackedBlockDeviceTest
{
    ...
    public TrackedBlockDeviceTest(int blockNumber, int seed, CylinderHead expectedTrack, int expectedPhysSector)
    {
    ...
    public void commitTrackMapsBlockToCorrectTrack() throws IOException
    {
        ...
        RecordingTrackedBlockDevice device =
                new RecordingTrackedBlockDevice(diskLayout, image);
        ...
        assertThat(image.get(expectedTrack.cylinder(), expectedTrack.head(), expectedPhysSector)
                .data.toByteArray())
                .isEqualTo(dataBlock(seed).toByteArray());
    }
    ...
    public void populateTrackMapsBlockToCorrectTrack() throws IOException
    {
        ...
        image.put(expectedTrack.cylinder(), expectedTrack.head(), expectedPhysSector)
                .data = dataBlock(seed);
    ...
    public void writeCommitReadRoundTrip() throws IOException
    {
        ...
        RecordingTrackedBlockDevice device2 =
                new RecordingTrackedBlockDevice(diskLayout, image);
