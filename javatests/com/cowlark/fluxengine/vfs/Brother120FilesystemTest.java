...
public class Brother120FilesystemTest extends GenericFilesystemTest
{
    ...
    public void setup()
    {
        configProto = new ConfigBuilder().loadConfigFile("brother").withImageWriter("/tmp/out.img").build();
    ...
    public void createTestFilesystem()
    {
        ...
        impl = new Brother120Filesystem(configProto.getFilesystem().getBrother120(), blockDevice);
    }
}
