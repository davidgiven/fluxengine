...
public class ZDosFilesystemTest extends GenericFilesystemTest
{
    ...
    public void setup()
    {
        configProto = new ConfigBuilder().loadConfigFile("zilogmcz").withImageWriter("/tmp/out.img").build();
    ...
    public void createTestFilesystem()
    {
        ...
        impl = new ZDosFilesystem(configProto.getFilesystem().getZdos(), blockDevice);
    }
}
