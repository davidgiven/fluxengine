...
public class DiskLayoutTest
{
    ...
    public void testPhysicalSectors()
    {
        ...
        assertThat(diskLayout.layoutByLogicalLocation.get(new CylinderHead(0, 0)))
    ...
    public void test_bounds()
    {
        ...
        addLayoutData(config).setSectorSize(256)
                .getPhysicalBuilder().setStartSector(0).setCount(12).setSkew(6);
        ...
        assertThat(diskLayout.getLogicalBounds())
                .isEqualTo(new DiskLayout.LayoutBounds(0, 1, 0, 1));
        assertThat(diskLayout.getPhysicalBounds())
                .isEqualTo(new DiskLayout.LayoutBounds(0, 3, 0, 1));
    }
    ...
    public void test_sectoroffsets()
    {
        ...
        assertThat(diskLayout.logicalSectorLocationBySectorOffset)
                .isEqualTo(ImmutableMap.<Long, LogicalLocation>builder()
                        .put(0L, new LogicalLocation(0, 0, 0))
                        .put(256L, new LogicalLocation(0, 0, 2))
                        .put(512L, new LogicalLocation(0, 0, 1))
                        .put(768L, new LogicalLocation(0, 0, 3))
                        .put(1024L, new LogicalLocation(0, 1, 0))
                        .put(1280L, new LogicalLocation(0, 1, 2))
                        .put(1536L, new LogicalLocation(0, 1, 1))
                        .put(1792L, new LogicalLocation(0, 1, 3))
                        .put(2048L, new LogicalLocation(1, 0, 0))
                        .put(2304L, new LogicalLocation(1, 0, 2))
                        .put(2560L, new LogicalLocation(1, 0, 1))
                        .put(2816L, new LogicalLocation(1, 0, 3))
                        .put(3072L, new LogicalLocation(1, 1, 0))
                        .put(3328L, new LogicalLocation(1, 1, 2))
        ...
        assertThat(diskLayout.sectorOffsetByLogicalSectorLocation)
                .isEqualTo(ImmutableMap.<LogicalLocation, Long>builder()
                        .put(new LogicalLocation(0, 0, 0), 0L)
                        .put(new LogicalLocation(0, 0, 1), 512L)
                        .put(new LogicalLocation(0, 0, 2), 256L)
                        .put(new LogicalLocation(0, 0, 3), 768L)
                        .put(new LogicalLocation(0, 1, 0), 1024L)
                        .put(new LogicalLocation(0, 1, 1), 1536L)
                        .put(new LogicalLocation(0, 1, 2), 1280L)
                        .put(new LogicalLocation(0, 1, 3), 1792L)
                        .put(new LogicalLocation(1, 0, 0), 2048L)
                        .put(new LogicalLocation(1, 0, 1), 2560L)
                        .put(new LogicalLocation(1, 0, 2), 2304L)
                        .put(new LogicalLocation(1, 0, 3), 2816L)
                        .put(new LogicalLocation(1, 1, 0), 3072L)
                        .put(new LogicalLocation(1, 1, 1), 3584L)
                        .put(new LogicalLocation(1, 1, 2), 3328L)
    ...
    {
        return diskLayout.layoutByPhysicalLocation
                .get(new CylinderHead(cylinder, head)).logicalTrackLayout;
    }

    private static ConfigProto.Builder baseConfig(
            com.cowlark.fluxengine.external.FormatType formatType)
    {
