...
public class BitWriterTest
{
    ...
    public void writesWholeByte()
    {
        ...
        assertThat(bytes.toArray()).isEqualTo(new byte[] {(byte) 0xd6});
    }
    ...
    public void packsAcrossBytes()
    {
        ...
        assertThat(bytes.toArray()).isEqualTo(new byte[] {(byte) 0xd6, 0x05});
    }
    ...
    public void flushesPartialByte()
    {
        ...
        assertThat(bytes.toArray()).isEqualTo(new byte[] {0x05});
    }
}
