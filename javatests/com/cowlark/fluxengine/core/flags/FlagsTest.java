...
public class FlagsTest
{
    ...
    {
        FlagGroup group = new FlagGroup();
        SettableFlag flag = SettableFlag
                .builder()
                .setGroup(group)
                .setName("--read-only")
