...
public class WriteOperation extends ReadOperation
{
    ...
    //    private static void writeTracks(ImmutableList<CylinderHead> chs)
    //    {
    //        writeTracks(
    //                ltl -> {
    ...
    //    private void writeTracksAndVerify(ConfigProto config,
    ...
    //                    ReadOperation.ReadGroupResult rgr =
    //                            readGroup(fluxSourceIteratorHolder, ltl, tracks);
    ...
    {
        //            ImmutableSet<CylinderHead> chs = getDiskLayout().layoutByLogicalLocation
        //            .keySet();
    ...
    public void writeRawDiskCommand()
    {
        writeTracks(
                ltl -> {
