 ...
 */
public record TrackReadLogMessage(List<Track> tracks, List<Sector> sectors) implements LogMessage
{
    @Override
    public void render(LogRenderer r)
    {
        Set<Sector> rawSectors = new HashSet<>();
        Set<Record> rawRecords = new HashSet<>();
