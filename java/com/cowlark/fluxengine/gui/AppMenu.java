...
public class AppMenu
{
    public static UI.MenuBar createMenu()
    {
        ...
        return of(new UI.MenuBar()).add(menu("File").add(menuItem("About FluxEngine...").onClick(it -> UiUtils.fireAction(new AboutAction(),
                                it.getComponent())))
                        .add(separator())
                        .add(menuItem("Exit").onClick(it -> System.exit(0))))
                .add(menu("Edit").add(actionMenuItem(
                                "Cut",
                                "cut",
    ...
    static UIForMenuItem<JMenuItem> actionMenuItem(String name,
                                                   String iconName,
                                                   Action action,
                                                   KeyStroke keyStroke)
    {
