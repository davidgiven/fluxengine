...
public class AdflibTest
{
    ...
    private byte[] getFile(String name)
    {
        ...
        // Use absolute get to not depend on position (no flip, absolute put doesn't advance position)
        for (int i = 0; i < size; i++)
            out[i] = buf.get(i);
        return out;
    }
    ...
    public void getFreeBlocks()
    {
        ...
        // Bitmap is stubbed; just verify count is non-negative and does not increase after allocation
