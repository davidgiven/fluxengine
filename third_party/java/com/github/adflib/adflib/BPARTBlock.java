...
public final class BPARTBlock
{
    ...
    public static BPARTBlock read(ByteBuffer buf, int off)
    {
        ...
        for (int i = 0; i < 31; i++)
            blk.name[i] = b.get(off + 37 + i);
        for (int i = 0; i < 15; i++)
            blk.r2[i] = b.getInt(off + 68 + i * 4);
        ...
        for (int i = 0; i < 4; i++)
            blk.dosType[i] = b.get(off + 0xc0 + i);
        for (int i = 0; i < 15; i++)
            blk.r3[i] = b.getInt(off + 0xc4 + i * 4);
        return blk;
    }
    ...
    public void write(ByteBuffer buf, int off)
    {
        ...
        for (int i = 0; i < 31; i++)
            b.put(off + 37 + i, name[i]);
        for (int i = 0; i < 15; i++)
            b.putInt(off + 68 + i * 4, r2[i]);
        ...
        for (int i = 0; i < 4; i++)
            b.put(off + 0xc0 + i, dosType[i]);
        for (int i = 0; i < 15; i++)
            b.putInt(off + 0xc4 + i * 4, r3[i]);
    }
