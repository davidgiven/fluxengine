...
public final class AdfRaw
{
    ...
    public static final int[][] swapTable = {{4, SW_CHAR, 2, SW_LONG, 1012, SW_CHAR, 0, 1024},
            /* first bytes of boot */
            {108, SW_LONG, 40, SW_CHAR, 10, SW_LONG, 0, 512},
            /* root */
            {6, SW_LONG, 488, SW_CHAR, 0, 512},
            /* data */
            /* file, dir, entry */
            ...
            {4, SW_CHAR, 39, SW_LONG, 56, SW_CHAR, 10, SW_LONG, 0, 256},
            /* RDSK */
            {4, SW_CHAR, 127, SW_LONG, 0, 512},
            /* BADB */
            {4, SW_CHAR, 8, SW_LONG, 32, SW_CHAR, 31, SW_LONG, 4, SW_CHAR, /* PART */
                    15, SW_LONG, 0, 256},
            {4, SW_CHAR, 7, SW_LONG, 4, SW_CHAR, 55, SW_LONG, 0, 256},
            /* FSHD */
            {4, SW_CHAR, 4, SW_LONG, 492, SW_CHAR, 0, 512}
            /* LSEG */};
    ...
    public static AdfError adfReadBootBlock(Volume vol, BBootBlock boot)
    {
        ...
        System.arraycopy(
                ...
                0,
                buf,
                AdfConstants.LOGICAL_BLOCK_SIZE,
                AdfConstants.LOGICAL_BLOCK_SIZE);
    ...
    public static AdfError adfWriteBootBlock(Volume vol, BBootBlock boot)
    {
        ...
        byte[] second = Arrays.copyOfRange(
                buf,
                AdfConstants.LOGICAL_BLOCK_SIZE,
                AdfConstants.LOGICAL_BLOCK_SIZE * 2);
