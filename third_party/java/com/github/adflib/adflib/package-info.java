 ...
 *   <li>High-level objects ({@link com.github.adflib.adflib.Device},
 *       {@link com.github.adflib.adflib.Volume},
 *       {@link com.github.adflib.adflib.File},
 *       {@link com.github.adflib.adflib.Entry}) are plain POJOs.</li>
 *   <li>Return codes keep the C {@code RETCODE} numeric values via
 *       {@link com.github.adflib.adflib.AdfError} (overlapping values
 *       preserved).</li>
 ...
 *       {@code Long}, {@code swapShort}, etc. via
 *       {@link com.github.adflib.adflib.AdfEndian}).</li>
 * </ul>
 *
 * <p>Headers {@code defendian.h} and {@code prefix.h}:
 * {@code defendian.h} selected {@code LITT_ENDIAN} on little-endian hosts;
 * in Java this is represented by {@link com.github.adflib.adflib.AdfEndian}
 * providing
