...
namespace snowhouse
{
    ...
    {
        EndsWithConstraint(const ExpectedType& expected): m_expected(expected)
        {
        }
    ...
    template <typename ExpectedType>
    inline EndsWithConstraint<ExpectedType> EndsWith(
    ...
    struct Stringizer<EndsWithConstraint<ExpectedType>>
    {
        static std::string ToString(
            const EndsWithConstraint<ExpectedType>& constraint)
        {
