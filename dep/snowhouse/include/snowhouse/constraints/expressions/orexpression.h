...
namespace snowhouse
{
    ...
    struct OrExpression :
        Expression<OrExpression<LeftExpression, RightExpression>>
    {
    ...
    struct Stringizer<OrExpression<LeftExpression, RightExpression>>
    {
        static std::string ToString(
            const OrExpression<LeftExpression, RightExpression>& expression)
        {
            std::ostringstream builder;
            builder << snowhouse::Stringize(expression.m_left) << " or "
                    << snowhouse::Stringize(expression.m_right);
