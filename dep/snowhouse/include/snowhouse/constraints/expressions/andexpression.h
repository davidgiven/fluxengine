...
namespace snowhouse
{
    ...
    struct AndExpression :
        Expression<AndExpression<LeftExpression, RightExpression>>
    {
    ...
    struct Stringizer<AndExpression<LeftExpression, RightExpression>>
    {
        static std::string ToString(
            const AndExpression<LeftExpression, RightExpression>& expression)
        {
            std::ostringstream builder;
            builder << Stringize(expression.m_left) << " and "
                    << Stringize(expression.m_right);
