    ...
    public:
        ...
        void square(int x, int y, int r)
        {
            if (visible(x, y, r))
            {
                if (r)
                    ...
                    base_type::ren().blend_pixel(
                        x, y, base_type::fill_color(), cover_full);
            }
        }
            ...
            if (visible(x, y, r))
            {
                if (r)
                {
                    ...
                    if (r <= 2)
                        r6++;
                    r >>= 1;
                    base_type::ren().blend_hline(
                        x - r6, y, x - r, base_type::line_color(), cover_full);
                    base_type::ren().blend_hline(
                        x + r, y, x + r6, base_type::line_color(), cover_full);
                    base_type::ren().blend_vline(
                        x, y - r6, y - r, base_type::line_color(), cover_full);
                    base_type::ren().blend_vline(
                        x, y + r, y + r6, base_type::line_color(), cover_full);
                }
                else
                {
                    base_type::ren().blend_pixel(
        ...
        void four_rays(int x, int y, int r)
        {
            if (visible(x, y, r))
            {
                if (r)
                {
                    ...
                    base_type::solid_rectangle(
                        x + r3 + 1, y + r3 + 1, x - r3 - 1, y - r3 - 1);
                }
                else
                {
                    base_type::ren().blend_pixel(
        ...
        void cross(int x, int y, int r)
        {
            if (visible(x, y, r))
            {
                ...
                {
                    base_type::ren().blend_vline(
                        x, y - r, y + r, base_type::line_color(), cover_full);
                    base_type::ren().blend_hline(
                        x - r, y, x + r, base_type::line_color(), cover_full);
                }
                else
                {
                    base_type::ren().blend_pixel(
        ...
        void markers(int n, const T* x, const T* y, T r, marker_e type)
        {
            ...
            if (r == 0)
            {
                ...
                {
                    base_type::ren().blend_pixel(
                        int(*x), int(*y), base_type::fill_color(), cover_full);
                    ++x;
                    ++y;
                } while (--n);
                return;
