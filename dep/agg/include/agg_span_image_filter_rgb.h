...
namespace agg
{
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                const value_type* fg_ptr =
                    (const value_type*)base_type::source().span(
    ...
    public:
        ...
        span_image_filter_rgb_bilinear() {}
        span_image_filter_rgb_bilinear(
            source_type& src, interpolator_type& inter):
            base_type(src, inter, 0)
        {
        }
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                fg_ptr =
                    (const value_type*)base_type::source().span(x_lr, y_lr, 2);
                ...
                span->r = color_type::downshift(
                    fg[order_type::R], image_subpixel_shift * 2);
                span->g = color_type::downshift(
                    fg[order_type::G], image_subpixel_shift * 2);
                span->b = color_type::downshift(
                    fg[order_type::B], image_subpixel_shift * 2);
                span->a = color_type::full_value();
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                if (x_lr >= 0 && y_lr >= 0 && x_lr < maxx && y_lr < maxy)
                {
                    ...
                    fg_ptr =
                        (const value_type*)base_type::source().row_ptr(y_lr) +
                        x_lr + x_lr + x_lr;
                    ...
                    fg[0] =
                        color_type::downshift(fg[0], image_subpixel_shift * 2);
                    fg[1] =
                        color_type::downshift(fg[1], image_subpixel_shift * 2);
                    fg[2] =
                        color_type::downshift(fg[2], image_subpixel_shift * 2);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        weight = (image_subpixel_scale - x_hr) *
                                 (image_subpixel_scale - y_hr);
                        if (x_lr >= 0 && y_lr >= 0 && x_lr <= maxx &&
                            y_lr <= maxy)
                        {
                            fg_ptr =
                                (const value_type*)base_type::source().row_ptr(
                                    y_lr) +
                                x_lr + x_lr + x_lr;
                        ...
                        fg[0] = color_type::downshift(
                            fg[0], image_subpixel_shift * 2);
                        fg[1] = color_type::downshift(
                            fg[1], image_subpixel_shift * 2);
                        fg[2] = color_type::downshift(
                            fg[2], image_subpixel_shift * 2);
                        src_alpha = color_type::downshift(
    ...
    public:
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                if (fg[order_type::R] > color_type::full_value())
                    fg[order_type::R] = color_type::full_value();
                if (fg[order_type::G] > color_type::full_value())
                    fg[order_type::G] = color_type::full_value();
                if (fg[order_type::B] > color_type::full_value())
                    fg[order_type::B] = color_type::full_value();
            ...
            do
            {
                ...
                for (;;)
                {
                    ...
                    for (;;)
                    {
                        ...
                        fg_ptr =
                            (const value_type*)base_type::source().next_x();
                    }
    ...
    public:
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                int len_x_lr = (diameter * rx + image_subpixel_mask) >>
                               image_subpixel_shift;
