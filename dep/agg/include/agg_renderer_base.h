    ...
    public:
            ...
            cover_type cover)
        {
            ...
            if (rc.clip(clip_box()))
            {
                ...
                {
                    m_ren->blend_hline(
                        rc.x1, y, unsigned(rc.x2 - rc.x1 + 1), c, cover);
                }
            }
        }
        ...
        //--------------------------------------------------------------------
        rect_i clip_rect_area(
            rect_i& dst, rect_i& src, int wsrc, int hsrc) const
        {
            rect_i rc(0, 0, 0, 0);
            rect_i cb = clip_box();
            ++cb.x2;
            ...
            int dy = 0)
        {
            ...
            if (rc.x2 > 0)
            {
                ...
                {
                    m_ren->copy_from(
                        src, rdst.x1, rdst.y1, rsrc.x1, rsrc.y1, rc.x2);
                    rdst.y1 += incy;
                    rsrc.y1 += incy;
                    --rc.y2;
                }
            ...
            cover_type cover = agg::cover_full)
        {
            ...
            if (rc.x2 > 0)
            {
                ...
                while (rc.y2 > 0)
                {
                    typename SrcPixelFormatRenderer::row_data rw =
                        src.row(rsrc.y1);
                    if (rw.ptr)
                    {
                        int x1src = rsrc.x1;
