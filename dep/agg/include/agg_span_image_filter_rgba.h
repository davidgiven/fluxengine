    ...
    public:
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                span->r = value_type(color_type::downshift(
                    fg[order_type::R], image_subpixel_shift * 2));
                span->g = value_type(color_type::downshift(
                    fg[order_type::G], image_subpixel_shift * 2));
                span->b = value_type(color_type::downshift(
                    fg[order_type::B], image_subpixel_shift * 2));
                span->a = value_type(color_type::downshift(
                    fg[order_type::A], image_subpixel_shift * 2));
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                if (x_lr >= 0 && y_lr >= 0 && x_lr < maxx && y_lr < maxy)
                {
                    ...
                    fg[3] =
                        color_type::downshift(fg[3], image_subpixel_shift * 2);
                }
                else
                {
